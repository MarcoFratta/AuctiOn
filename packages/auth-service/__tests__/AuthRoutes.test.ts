...
describe('Auth Router', () => {
    ...
    describe('POST /auth/register', () => {
        it('should call the register method of AuthController', async () => {
            ...
            ;(authController.register as jest.Mock).mockImplementationOnce(
                (req, res) => res.status(201).json(registerResponse)
            )
    ...
    describe('POST /auth/validate', () => {
        it('should call the validateToken method of AuthController', async () => {
            ...
            ;(authController.validateToken as jest.Mock).mockImplementationOnce(
                (req, res) => res.status(200).json(validateResponse)
            )
